...
impl super::TermWindow {
    ...
    pub fn apply_dimensions(
        ...
        let left_dock_width = self.left_dock_pixel_width() as usize;
        let chrome_height = tab_bar_height + top_bar_height;
        ...
        let (size, dims, ri_calc) = if let Some(cell_dims) = scale_changed_cells {
            ...
            let padding_left =
                config.window_padding.left.evaluate_as_pixels(h_context) as usize + left_dock_width;
            ...
            let ri_calc = ResizeIncrementCalculator {
                ...
                border: border,
                chrome_height: chrome_height as usize,
            };
            ...
            let avail_height = dimensions
                ...
                .saturating_sub(chrome_height as usize);
    ...
    pub fn set_window_size(&mut self, size: TerminalSize, window: &Window) -> anyhow::Result<()> {
        ...
        let top_bar_height = self.top_bar_pixel_height() as usize;
        let left_dock_width = self.left_dock_pixel_width() as usize;
