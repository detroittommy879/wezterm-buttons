...
impl crate::TermWindow {
    ...
    pub fn paint_pane(
        ...
        */
        ...
        let top_pixel_y = self.top_chrome_pixel_height() + padding_top + border.top.get() as f32;
        ...
        let background_rect = {
            ...
            let (x, width_delta) = if pos.left == 0 {
                (0., left_pixel_x_base + (cell_width / 2.0))
            } else {
                (
                    left_pixel_x_base - (cell_width / 2.0) + (pos.left as f32 * cell_width),
                    cell_width,
                )
            };
        ...
        if pos.is_active && self.show_scroll_bar {
            let thumb_y_offset = self.top_chrome_pixel_height() as usize + border.top.get();
